...
vulnerability reporting is unavailable, email `furyx.ds@gmail.com` with the
subject `gotify_client security report`.

You will receive an acknowledgement after the report is reviewed. Remediation
and disclosure timing depend on severity and the availability of a safe fix; no
disclosure should occur until a coordinated date is agreed.
