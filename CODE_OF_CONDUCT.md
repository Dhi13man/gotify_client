...
When an incident does occur, report it promptly and privately to
`furyx.ds@gmail.com`. Include relevant links or records and any immediate safety
concerns. Reports will be handled confidentially to the extent possible.

Community Moderators take reports of violations seriously and will make every
effort to respond in a timely manner. They will investigate reports by reviewing
available records or interviewing involved parties. Enforcement actions are
carried out privately, although a mutually agreed resolution may include a
public communication.

## Addressing and Repairing Harm

If an investigation finds that this Code of Conduct has been violated, the
following enforcement ladder may be used according to the incident's impact.
Depending on severity, lower steps may be skipped.

1. **Warning**
   - **Event:** A violation involving a single incident or series of incidents.
   - **Consequence:** A private, written warning from the Community Moderators.
   - **Repair:** Acknowledgement of responsibility, clarification of
     expectations, or an appropriate apology.
2. **Temporarily limited activities**
   - **Event:** A repeated violation after a warning, or the first occurrence of
     a more serious violation.
   - **Consequence:** A private warning with a time-limited cooldown period for
     specified channels or interactions.
   - **Repair:** Reflection, an appropriate apology, and a thoughtful return to
     community spaces.
3. **Temporary suspension**
   - **Event:** Repeated violations that warnings did not resolve, or a single
     serious violation.
   - **Consequence:** A private written notice with conditions for return.
   - **Repair:** Respecting the suspension and meeting the stated conditions
     before returning.
4. **Permanent ban**
   - **Event:** A pattern that other steps did not resolve, or a violation so
...
This ladder is a guideline and does not limit moderator discretion when
...
Its enforcement ladder was inspired by
